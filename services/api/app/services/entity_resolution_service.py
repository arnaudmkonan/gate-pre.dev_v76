...
class EntityResolutionService:
    ...
    async def resolve_document_entities(session: AsyncSession, document_id: str) -> Dict[str, Any]:
        ...
        for extraction in extractions:
            ...
            # --- Party Resolution ---
            if any(k in field_name for k in ['shipper', 'consignee', 'vendor', 'supplier', 'importer', 'exporter', 'manufacturer']):
            ...
            # --- Product Resolution ---
            elif any(k in field_name for k in ['product_desc', 'commodity', 'goods_desc']):
